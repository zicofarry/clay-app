            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      _statusLabels[state.orderStatus] ?? 'Status Pesanan',
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const Text('Kurir ClaySend', style: TextStyle(fontSize: 13, color: ClayColors.textSecondary)),
                                ],
                              ),
                            ),
                            Container(
                    ...
                    // ── Package info ──
                    const Text('Detail Pengiriman', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                    const SizedBox(height: 10),
                    Container(
                      padding: const EdgeInsets.all(14),
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text('Pengirim: ${state.senderName}', style: const TextStyle(fontSize: 13)),
                              Text('Penerima: ${state.recipientName}', style: const TextStyle(fontSize: 13)),
                            ],
                          ),
                        ],
                      ),
                  ...
                  onPressed: () {
                    showDialog(
                      ...
                      builder: (ctx) => AlertDialog(
                        ...
                        content: const Text('Paket belum diambil kurir. Yakin ingin membatalkan?'),
                        ...
                        actions: [
                          ...
                          TextButton(
                            onPressed: () {
                              Navigator.pop(ctx);
                              ref.read(sendStateProvider.notifier).cancelOrder(reason: 'User cancelled');
                            },
