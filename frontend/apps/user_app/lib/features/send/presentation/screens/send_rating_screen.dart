...
class SendRatingScreen extends ConsumerStatefulWidget {
  const SendRatingScreen({super.key});

  @override
  ConsumerState<SendRatingScreen> createState() => _SendRatingScreenState();
}

class _SendRatingScreenState extends ConsumerState<SendRatingScreen> {
  int _rating = 5;
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text('Kurir ClaySend', style: TextStyle(fontSize: 14, color: ClayColors.textSecondary)),
  ...
  void _onSubmit() async {
    await ref.read(sendStateProvider.notifier).submitRating(
      score: _rating,
